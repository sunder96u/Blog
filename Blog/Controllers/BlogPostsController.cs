...
namespace Blog.Controllers
{
    ...
    public class BlogPostsController : Controller
    {
        ...
        // GET: BlogPosts
        public ActionResult AllPosts(int? page1)
        {
            int pageSize1 = 5;
            int pageNumber1 = (page1 ?? 1);
            return View(db.BlogPosts.OrderByDescending(b => b.Created).ToPagedList(pageNumber1, pageSize1));
        }
